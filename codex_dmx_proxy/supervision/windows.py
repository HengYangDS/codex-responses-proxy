...
from codex_dmx_proxy import python_runtime
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    <Description>Codex DMX Proxy watchdog</Description>
  </RegistrationInfo>
  <Triggers>
    <LogonTrigger>
...
def _xml_path(ctx: installation.InstallContext) -> str:
    return os.path.join(ctx.install_dir, f"{TASK_NAME}.xml")


def _launcher_path(ctx: installation.InstallContext) -> str:
...
def render_launcher(ctx: installation.InstallContext) -> str:
...
def render_task_xml(ctx: installation.InstallContext) -> str:
...
def _running_watchdog_pids(ctx: installation.InstallContext) -> list[int]:
