...
from tests.compatibility.empty_response_fixture import body
from tests.compatibility.empty_response_fixture import semantic_body
from tests.listener.proxy_fixture import request
from tests.listener.proxy_fixture import serve_proxy
...
class EmptyResponseTransportTests(unittest.TestCase):
    ...
    def test_encrypted_only_agent_history_is_projected_once_then_retried_exactly(self):
        ...
        self.assertIn(rewrite.OPAQUE_CONTENT_MARKER, retried)
        self.assertNotIn(secret, retried)
    ...
    def test_fallback_follows_response_failed_recovery_without_metric_overlap(self):
        ...
        self.assertLess(len(received[1]), len(received[0]))
