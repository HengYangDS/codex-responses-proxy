...
from tests.runtime.handoff.fixtures import (
    HandoffTestCase,
    child_message,
...
class TestSuccessorHealthObservation(unittest.TestCase):
    ...
    def test_successor_observer_accepts_the_stable_finalized_health_state(self):
        ...
        with mock.patch("tests.runtime.handoff.fixtures.http_json", return_value=(200, health)):
    ...
    def test_successor_observer_rejects_non_successor_health(self):
        ...
        for health in cases:
            with (
                ...
                mock.patch("tests.runtime.handoff.fixtures.http_json", return_value=(200, health)),
            ):
...
class TestParentHandoffStateMachine(HandoffTestCase):
    ...
    def test_internal_fail_closed_branches_are_bounded(self):
        ...
        with (
            mock.patch.object(
                handoff_protocol_module.subprocess, "Popen", return_value=mock.Mock()
            ),
            mock.patch.object(handoff_protocol_module, "HandoffChild", return_value=child),
        ):
