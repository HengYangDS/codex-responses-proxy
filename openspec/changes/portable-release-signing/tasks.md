...
- [x] 1.1 Add a failing regression for path-based release signing.
- [x] 1.2 Remove temporary private-key materialization.
- [x] 1.3 Give GitHub and GitLab one protected key-path contract.
