...
- [x] 3.1 Align documentation and command help with the portable owners.
- [x] 3.2 Run quick, quality, Python 3.12/3.13/3.14, release, and strict OpenSpec gates.
- [x] 3.3 Prove Shell ELOC and cross-platform risk decreased, then archive and land.
