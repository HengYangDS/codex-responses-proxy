...
- [x] Add a failing GitHub workflow contract for supported Python minor lines.
- [x] Replace GitHub patch pins with the 3.12, 3.13, and 3.14 support lines.
- [x] Add a failing GitLab pipeline contract for the same support lines.
